...
class WebUI_es extends MdcLoggable{
  ...
  def cookieConsent = {
    ...
    val buttonString = """<input id="clickMe" class="btn btn-default" type="button" value="Aceptar y cerrar" onclick="%s"/> <script>showIndicatorCookiePage('cookies-consent'); </script>""".format(onclick)
  ...
  def concurrentLoginsCookiesCheck = {
    ...
    if(!firstKnownIPAddress.isEmpty & !firstKnownIPAddress.get.equals(updateIPaddressEachtime.get)) {
      log.warn("Atención! El ID de sesión está siendo utilizado en otra dirección IP, puede ser robada o usted cambió la red. Por favor verifique primero ! ")
      S.error("Atención! Otra dirección IP esta utilizando su ID de sesión. Cambió usted su red? ")
    }
    "#cookie-ipaddress-concurrent-logins" #> ""
  }

  def headerLogoLeft = {
    "img [src]" #> getWebUiPropsValue("webui_es_header_logo_left_url", "")
  }

  def headerLogoRight: CssSel = {
    "img [src]" #> getWebUiPropsValue("webui_es_header_logo_right_url", "")
  }

  def footer2LogoLeft = {
    "img [src]" #> getWebUiPropsValue("webui_es_footer2_logo_left_url", "")
  }

  def footer2MiddleText: CssSel = {
    "#footer2-middle-text *" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_footer2_middle_text", ""))
  }
  ...
  def aboutText: CssSel = {
    "#main-about-text *" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_index_page_about_section_text", ""))
  }

  def topText: CssSel = {
    "#top-text *" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_top_text", ""))
  }
  ...
  def apiExplorerLink: CssSel = {
    ...
    val baseUrl = getWebUiPropsValue("webui_es_api_explorer_url", "")
  ...
  def apiManagerLink: CssSel = {
    ".api-manager-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_manager_url", ""))
  }
  
  // Link to OBP-CLI
  def obpCliLink: CssSel = {
    ".obp-cli-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_obp_cli_url", "https://github.com/OpenBankProject/OBP-CLI"))
  }

  // Link to API Tester
  def apiTesterLink: CssSel = {
    ".api-tester-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_tester_url", ""))
  }
  ...
  // Social Finance (Sofi)
  def sofiLink: CssSel = {
    ".sofi-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_sofi_url", ""))
  }
  
  // Terms&Conditions
  def termsAndConditions: CssSel = {
    ".termsAndConditions-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_agree_terms_url", ""))
  }

  def sandboxIntroductionLink: CssSel = {
    "#sandbox-introduction-link [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_documentation_url",s"${getServerUrl}/introduction"))
  }
  ...
  def createDirectLoginToken: CssSel = {
    getWebUiPropsValue("webui_es_create_directlogin_token_url", "") match {
  ...
  def apiDocumentationLink: CssSel = {
    ".api-documentation-link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_documentation_url", "https://github.com/OpenBankProject/OBP-API/wiki"))
  }
  ...
  def exampleSandboxCredentialsLink: CssSel = {
    ".example_sandbox_credentials_link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_documentation_url", "") + "#customer-logins")
  }

  // For link to OAuth Client SDKs
  def sdksLink: CssSel = {
    ".sdks_link a [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_sdks_url", "https://github.com/OpenBankProject/OBP-API/wiki/OAuth-Client-SDKS"))
  }

  // Text about data in FAQ
  def faqDataText: CssSel = {
    ".faq-data-text *" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_faq_data_text", "This depends on the end point and/or OBP instance you are using. A combination of synthetic, anonymised and real data may be available. Please ask support for more information."))
  }
  ...
  // Link to FAQ
  def faqLink: CssSel = {
    val link = scala.xml.Unparsed(getWebUiPropsValue("webui_es_faq_url", "https://openbankproject.com/faq/"))
    //".faq-link a *" #>  link &
  ...
  def faqEmail: CssSel = {
    val email = scala.xml.Unparsed(getWebUiPropsValue("webui_es_faq_email", "contact@openbankproject.com"))
  ...
  val apiExplorerUrl = scala.xml.Unparsed(getWebUiPropsValue("webui_es_api_explorer_url", ""))

  // DirectLogin documentation url
  def directLoginDocumentationUrl: CssSel = {
    val directlogindocumentationurl = scala.xml.Unparsed(getWebUiPropsValue("webui_es_direct_login_documentation_url", apiExplorerUrl + "/glossary#Direct-Login"))
  ...
  def oauth1DocumentationUrl: CssSel = {
    val oauth1documentationurl = scala.xml.Unparsed(getWebUiPropsValue("webui_es_oauth_1_documentation_url", apiExplorerUrl + "/glossary#OAuth-1.0a"))
    ".oauth-1-documentation-url a [href]" #> oauth1documentationurl
  }

  // OAuth2.0 link on FAQ
  def oauth2DocumentationUrl: CssSel = {
    val oauth2documentationurl = scala.xml.Unparsed(getWebUiPropsValue("webui_es_oauth_2_documentation_url", apiExplorerUrl + "/glossary#OAuth-2"))
  ...
  def supportPlatformLink: CssSel = {
    val supportplatformlink = scala.xml.Unparsed(getWebUiPropsValue("webui_es_support_platform_url", "https://slack.openbankproject.com/"))
  ...
  // Page title
  def pageTitle = {
    val prefix = getWebUiPropsValue("webui_es_page_title_prefix", "Open Bank Project: ")
    scala.xml.XML.loadString(s"<title>$prefix<lift:Menu.title /></title>")
  }

  def mainStyleSheet: CssSel = {
    "#main_style_sheet [href]" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_main_style_sheet", "/media/css/website.css"))
  }



  def getStartedText: CssSel = {
    "@get-started *" #> scala.xml.Unparsed(getWebUiPropsValue("webui_es_get_started_text", "Get started building your applications now!"))
  }


  val displayForBanks = if (APIUtil.getPropsAsBoolValue("webui_es_display_for_banks_section", true)) {
  ...
  def getStartedContentLoader: NodeSeq = {
    contentLoader("webui_es_get_started_content_url", "main-get-started")
  }

  def vendorSupportContentLoader: NodeSeq = {
    contentLoader("webui_es_vendor_support_content_url", "vendor-support")
  }

  def aboutVendorContentLoader: NodeSeq = {
    contentLoader("webui_es_about_vendor_content_url", "about-vendor")
  }


// This load content directly into the div that calls it.
  def getStartedDirectContentLoader: NodeSeq = {
    directContentLoader("webui_es_get_started_content_url")
  }

  def vendorSupporDirectContentLoader: NodeSeq = {
    directContentLoader("webui_es_vendor_support_content_url")
  }

  def aboutVendorDirectContentLoader: NodeSeq = {
    directContentLoader("webui_es_about_vendor_content_url")
  }
  ...
  def overrideStyleSheet: CssSel = {
    val stylesheet = getWebUiPropsValue("webui_es_override_style_sheet", "")
  ...
  def createMainPartners: CssSel = {
    ...
    val mainPartners: Option[String] = {
      Some(getWebUiPropsValue("webui_es_main_partners", ""))
    }
